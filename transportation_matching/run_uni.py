    ...
    for d in d_list:
        ...
        for i in range(num_designs): 
            try:
                ...
                elif graph_type == 'Probabilistic Expander':
                    # For now, use ER graph as placeholder for Probabilistic Expander
                    # You may need to implement a specific probabilistic expander function
                    graph_adj = ER_unipartite(n, d, seed + i*100)
...
def generate_plot(results, n, p, seed):
    ...
    marker_list = {
        'Erdos-Renyi': 's', 
        'Probabilistic Expander': 'x',
        'Random Regular': 'd',
        'K Chain': '*'
    }
    label_list = {
        'Erdos-Renyi': 'Erdős-Rényi',
        'Probabilistic Expander': 'Probabilistic Expander',
        'Random Regular': r'Random $d$-Regular',
        'K Chain': r'$K$-Chain'
    }
    color_list = {
        'Erdos-Renyi': 'C0',
        'Probabilistic Expander': 'C1',
        'Random Regular': 'C2',
        'K Chain': 'C3'
    }
    ...
    plt.title(f"Performance for Transportation Flexibility (n={n}, p={p})", fontsize=14)
